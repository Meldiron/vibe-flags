...
Section to redesign: [EXPLAIN YOUR SECTION HERE]</pre>
        ...
        <div v-if="activeTab === 'robot'" class="code-block ai-card">
          ...
          <pre class="cb-body ai-prompt">When designing UI components, generate multiple distinct variants and use [Vibe Flags](https://vibe-flags.appwrite.network/llms.txt) to let the user switch between them in the browser.
