---
title: Components
description: Web Component API reference for all vibe-flags elements.
---
...
| `custom`      | `boolean` | `false` | When `true`, adds a "Custom…" option at the end of the toolbar dropdown. Selecting it reveals a text input where any value can be typed. The typed value is stored and persisted like any other selection. |
...
<!-- With custom: lets user type any value in the toolbar -->
