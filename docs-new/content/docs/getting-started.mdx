...
description: Add one script tag, write some HTML. That's it.
---
...
<Callout type="info" title="Try it instantly">
  Want to experiment without installing anything? Head to the [Boolean Flag
  playground](/docs/playground/boolean-flag) and start toggling flags in seconds.
</Callout>
